$(document).ready(function () {
  //new custom add new user
  $(document).on('click', '.custom_user_add', function () {
    //user Info
    ...
    //RFID Info
    var rfid_card_number = $('#rfid_card_number').val()
    //Additional Info
    ...
    $.ajax({
      ...
      success: function (response) {
        if (response == 1) {
          ...
          $('.alert_user').fadeIn(500)
          $('.alert_user').html(
            '<p class="alert alert-success">The selected User has been updated!</p>'
          )
        } else {
          $('.alert_user').fadeIn(500)
          $('.alert_user').html(
          ...
          $.ajax({
            ...
            success: function (response) {
              if (response == 1) {
                ...
                $('.alert_user').fadeIn(500)
                $('.alert_user').html(
                  '<p class="alert alert-success">The selected User has been deleted!</p>'
                )
              } else {
                $('.alert_user').fadeIn(500)
                $('.alert_user').html(
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        if (user_gender.User_gender == 'Female') {
          $('.form-style-5')
            .find(':radio[name=gender][value="Female"]')
            .prop('checked', true)
        } else {
          $('.form-style-5')
            .find(':radio[name=gender][value="Male"]')
            .prop('checked', true)
        }
      },
      error: function (data) {
